...
// menciptakan database dengan tabel yang dibutuhkan dan handle ketika terjadi
// perubahan skema pada tabel (terjadi pada metode onUpgrade())
internal class DatabaseHelper (context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val SQL_CREATE_TABLE_NOTE =
            "CREATE TABLE $TABLE_NAME" + " (${DatabaseContract.NoteColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT," +
